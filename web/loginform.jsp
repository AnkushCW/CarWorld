...
<script>
    function al(form) {
if (form.cont.value=="abrar4295@gmail.com") { 
if (form.apass.value=="9213@580") {              
...
<img src="images/mn1.jpeg" class="img-responsive" style="width:100%"/>
<div class="container">
<div class="row" style="color:#34495E">
    <h1> Desired Car's </h1></h1>
<h3>Welcome to Desire car's.com - India's largest auto media vehicle. Desire car's.com has always striven to serve car buyers and owners in the most comprehensive and convenient way possible. We provide a platform where car buyers and owners can research, buy, sell and come together to discuss and talk about their cars....</h3>
