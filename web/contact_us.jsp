...
<html>
    <head>
        ...
        #backview{height:100; width: 100;
            background-image : url('images/conbck1.jpeg'); 
        }
...
<div class="row">
<div class="col-sm-3">
 <a href="https://www.facebook.com/Desire-Car-422417681493621/" class= "social_icon"> <i class="fa fa-facebook" style ="color:blue; size:17px; font-size:17px"></i></a>
 <a href="https://www.twitter.com" class= "social_icon"> <i class="fa fa-twitter" style ="color:burlywood; size:17px; font-size:17px"></i></a>
	...
	<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
	   ...
	   <div class="carousel-inner">
    	  ...
    	  <div class="item active">
              <img src="images/conbck1.jpeg" alt="image">
			...
			<div class="page-heading">
                            ...
                            <div id="polina" style="color:darkblue; background-color: #ffffff; opacity:0.7; padding:10px">
        ...
        <div class="contact_detail">
          <ul>
            ...
            <li>
              ...
              <div class="contact_info_m"><a href="tel:61-1234-567-90">+91 8285433485</a></div>
            </li>   
            <li>
              <div class="icon_wrap"><i class="fa fa-envelope-o" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href="mailto:contact@exampleurl.com">Desired Car's@gmail.com</a></div>
            </li>
          </ul>
        </div>
      </div>
